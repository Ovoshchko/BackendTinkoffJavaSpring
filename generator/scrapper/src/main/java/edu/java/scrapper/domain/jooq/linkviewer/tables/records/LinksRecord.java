...
public class LinksRecord extends UpdatableRecordImpl<LinksRecord> implements Record3<Long, String, LocalDateTime> {
    ...
    /**
     * Setter for <code>LINKVIEWER.LINKS.ID</code>.
     */
    ...
    /**
     * Getter for <code>LINKVIEWER.LINKS.ID</code>.
     */
    @Nullable
    public Long getId() {
        return (Long) get(0);
    ...
    /**
     * Setter for <code>LINKVIEWER.LINKS.URL</code>.
     */
    ...
    /**
     * Getter for <code>LINKVIEWER.LINKS.URL</code>.
     */
    ...
    /**
     * Setter for <code>LINKVIEWER.LINKS.LAST_CHECK</code>.
     */
    public void setLastCheck(@NotNull LocalDateTime value) {
        set(2, value);
    }

    /**
     * Getter for <code>LINKVIEWER.LINKS.LAST_CHECK</code>.
     */
    @jakarta.validation.constraints.NotNull
    @NotNull
    ...
    @Override
    @NotNull
    public LinksRecord values(@Nullable Long value1, @NotNull String value2, @NotNull LocalDateTime value3) {
        value1(value1);
        value2(value2);
        value3(value3);
        return this;
    ...
    public LinksRecord(@Nullable Long id, @NotNull String url, @NotNull LocalDateTime lastCheck) {
        super(Links.LINKS);
     ...
     * Create a detached, initialised LinksRecord
     */
    public LinksRecord(edu.java.scrapper.domain.jooq.linkviewer.tables.pojos.Links value) {
        super(Links.LINKS);
