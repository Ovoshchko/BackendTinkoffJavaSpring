...
public class Links extends TableImpl<LinksRecord> {
    ...
    /**
     * The reference instance of <code>LINKVIEWER.LINKS</code>
     */
    ...
    /**
     * The column <code>LINKVIEWER.LINKS.LAST_CHECK</code>.
     */
    public final TableField<LinksRecord, LocalDateTime> LAST_CHECK = createField(DSL.name("LAST_CHECK"), SQLDataType.LOCALDATETIME(6).nullable(false), this, "");
    ...
    /**
     * Create an aliased <code>LINKVIEWER.LINKS</code> table reference
     */
    ...
    /**
     * Create a <code>LINKVIEWER.LINKS</code> table reference
     */
    public Links() {
